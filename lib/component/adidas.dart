...
class AdidasShoes extends StatefulWidget {
  const AdidasShoes({super.key});

  @override
  State<AdidasShoes> createState() => _AdidasShoesState();
}

class _AdidasShoesState extends State<AdidasShoes> {
